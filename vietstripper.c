/*****************************************************************************
vietstripper
Removes tone-marks from Vietnamese characters in stdin and outputs plain ascii
Written by Huan Truong <htruong@tnhh.net>

Part of this program is taken from Latinime - Google AOSP
Part of this program is taken from Sophia keyboard - Huan Truong

Compile with:
$ $CC -o vietstripper vietstripper.c
$ echo "Mỹ Tâm" | ./vietstripper
My Tam
...
const unsigned short BASE_CHARS[] = {
...
const unsigned short BASE_CHARS_VI[] = {
...
static int isAscii(unsigned short c) {
	return c <= 127;
}

static unsigned short toBaseChar(unsigned short c) {
